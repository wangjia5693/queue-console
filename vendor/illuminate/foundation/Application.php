...
class Application extends Container implements ApplicationContract, HttpKernelInterface {
	...
	{
//	两个类的启动	"Illuminate\Foundation\Bootstrap\LoadConfiguration"；提供配置文件载入等配置
//		"Illuminate\Foundation\Bootstrap\RegisterProviders"执行本类的registerConfiguredProviders方法
	...
	public function register($provider, $options = array(), $force = false)
	{
		...
		// 如果实例已经启动，需要调用服务的boot方法，如果存在，保证服务的可用
		if ($this->booted)
		{
