...
class WorkCommand extends Command {
	 ...
	 *处理队列上的第一个工作；如果包含了--daemon选项，则会持续处理工作；
	 * php artisan help queue:work 命令来观看全部可用的选项参数。
	 * @return void
	 */
	public function fire()
	{
		...
		//$this->option('sleep')   让监听器在拉取新工作时要等待几秒；注意队列只会在工作时休息，假如有许多可执行的工作，队列会持续的处理工作而不会休息
